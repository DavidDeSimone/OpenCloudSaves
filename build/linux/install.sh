...
mkdir -p /tmp/
curl -L "https://github.com/DavidDeSimone/OpenCloudSaves/releases/download/v0.17.8/linux_opencloudsaves_0.17.8_x86_64.flatpak" > /tmp/opencloudsaves.flatpak
flatpak install --user --noninteractive --or-update /tmp/opencloudsaves.flatpak

if [[ -d ~/Desktop/ ]]; then
    curl -L "https://github.com/DavidDeSimone/OpenCloudSaves/releases/download/v0.17.8/OpenCloudSave.desktop" > ~/Desktop/OpenCloudSave.desktop
elif [[ -d /home/deck/Desktop/ ]]; then
    curl -L "https://github.com/DavidDeSimone/OpenCloudSaves/releases/download/v0.17.8/OpenCloudSave.desktop" > /home/deck/Desktop/OpenCloudSave.desktop
else 
